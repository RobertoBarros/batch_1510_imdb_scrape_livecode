...
def fetch_top_movie_urls
  ...
  doc.search('ul.sc-71ed9118-0 a.ipc-title-link-wrapper').first(5).each do |link|
...
def scrape_movie(url)
  ...
  # TODO: return movie info hash
  {
    ...
    year: doc.search('ul.sc-d8941411-2 a')[0].text.to_i,
    storyline: doc.search('.sc-466bb6c-0.hlbAws').text
  }
end
